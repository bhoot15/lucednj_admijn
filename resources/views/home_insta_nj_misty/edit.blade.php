...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Nj Misty Instagram Page
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Nj Misty Instagram Page</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Nj Misty Instagram List</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="container box-body table-responsive no-padding">
                            <form role="form" action="/home-insta-nj-misty/{{ $sc->id}}" method="post">
                                {{ method_field('PUT') }}
                                {{csrf_field()}}

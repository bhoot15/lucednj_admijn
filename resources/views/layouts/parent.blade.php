...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-lg">LuceD<b>NJ</b><small>Admin</small></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}} - Admin
...
<!-- /.content-wrapper -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y') ?> <a href="https://lucednj.com">lucednj</a>.</strong> All rights
        reserved.
    </footer>
